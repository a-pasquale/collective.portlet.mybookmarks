...
jq(document).ready(function() {
	...
	if (dd.length === 1) {
		var absolute_url=dd.children('span#hiddenAbsoluteUrl').html();
		...
		html+='href="#">';
		html+='<img class="bookmarkIcon" src="'+absolute_url+'/++resource++collective.portlet.mybookmarks.images/add.png" alt="[ADD]"/>';
